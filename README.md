...
See `docker-compose.yml` in this repo for a usage example. In the actual homelab deployment this
container is one service inside `compose-files/server/dashboard_energy/docker-compose.yml`,
